...
Atualmente focado em desenvolvimento Back-end, engenharia de software e construção de aplicações utilizando Java e Python.
...
<img src="https://via.placeholder.com/600x300" width="400">

</p>

<p align="center">

Sistema para gerenciamento de produtos, cadastro de itens e controle de estoque.
...
Dashboard para análise de dados, tratamento de informações e visualização de indicadores.
...
Scripts desenvolvidos para automatização de tarefas e otimização de processos.
...
Novos projetos envolvendo desenvolvimento Back-end, banco de dados e arquitetura de software.
